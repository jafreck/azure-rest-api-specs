...
tag: package-2020-08.12.0
```

### Tag: package-2020-08.12.0

These settings apply only when `--tag=package-2020-08-01.12.0` is specified on the command line.

``` yaml $(tag) == 'package-2020-08-01.12.0'
input-file:
- Microsoft.Batch/stable/2020-08-01.12.0/BatchService.json
```
